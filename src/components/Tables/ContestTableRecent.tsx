...
export const ContestTableRecent = ({ contests }: { contests: Contest[] }) => {
            ...
            {contests
              ...
              .map((contest) => (
                <TableRow key={contest.id}>
                  <TableCell>{contest.name}</TableCell>
                  <TableCell>{contest.preparedBy}</TableCell>
                  <TableCell>{"contest.questions"}</TableCell>
                  <TableCell>{contest.durationSeconds}</TableCell>
                  <TableCell>
